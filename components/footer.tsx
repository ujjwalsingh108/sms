    ...
    <footer className="bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-gray-300 border-t border-slate-200 dark:border-slate-800">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* User Links */}
          <div>
            <h3 className="text-slate-900 dark:text-white font-semibold mb-4 text-lg font-heading">
              USERLINKS
            </h3>
          ...
          <div>
            ...
            {/* Social Links */}
            <div className="mt-6">
              <h4 className="text-slate-900 dark:text-white font-semibold mb-3 text-sm font-heading">
                FOLLOW US
              </h4>
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      key={social.name}
                      href={social.href}
                      className="h-8 w-8 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-gray-400 hover:bg-blue-600 hover:text-white transition-all"
